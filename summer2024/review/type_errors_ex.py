...
print("When we try to concatenate an int, float, or bool with a bool, we are adding either 1 or 0.")
print("Note: this is because 'True' is stored as '1' and 'False' is stored as '0'.")
