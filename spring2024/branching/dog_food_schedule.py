"""
    Ask user if it is morning, afternoon, or evening, and remind the user
    to feed their pet if it is morning
...
# Display whether it is morning, afternoon, or evening.
